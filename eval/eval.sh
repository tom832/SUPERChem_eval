...
LANGUAGE="en"
MULTIMODAL=false  # Set to true or false
N_PROCS=4
N_THREADS=10
...
for config in "${MODELS[@]}"; do
    ...
    output_file="${OUTPUT_PREFIX}_${LANGUAGE}_${MULTIMODAL}_${safe_model}_${reasoning_effort}_${safe_temp}_${pass_k}.jsonl"
